...
import gnomock
from gnomock.models.postgres_request import PostgresRequest  # noqa: E501
from gnomock.rest import ApiException

class TestPostgresRequest(unittest.TestCase):
    """PostgresRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PostgresRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = gnomock.models.postgres_request.PostgresRequest()  # noqa: E501
        if include_optional :
            return PostgresRequest(
                preset = gnomock.models.postgres.Postgres(
                    db = 'mydb', 
                    user = 'gnomock', 
                    password = 'p@s$w0rD', 
