...
import gnomock
from gnomock.models.cassandra_request import CassandraRequest  # noqa: E501
from gnomock.rest import ApiException

class TestCassandraRequest(unittest.TestCase):
    """CassandraRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CassandraRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = gnomock.models.cassandra_request.CassandraRequest()  # noqa: E501
        if include_optional :
            return CassandraRequest(
                preset = gnomock.models.cassandra.cassandra(
                    version = 'latest', ), 
