...
import gnomock
from gnomock.models.elastic_request import ElasticRequest  # noqa: E501
from gnomock.rest import ApiException

class TestElasticRequest(unittest.TestCase):
    """ElasticRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = gnomock.models.elastic_request.ElasticRequest()  # noqa: E501
        if include_optional :
            return ElasticRequest(
                preset = gnomock.models.elastic.Elastic(
                    input_files = [
                        '0'
                        ], 
                    version = '7.9.2', ), 
