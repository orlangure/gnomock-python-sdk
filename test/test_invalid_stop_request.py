...
import gnomock
from gnomock.models.invalid_stop_request import InvalidStopRequest  # noqa: E501
from gnomock.rest import ApiException

class TestInvalidStopRequest(unittest.TestCase):
    """InvalidStopRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test InvalidStopRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = gnomock.models.invalid_stop_request.InvalidStopRequest()  # noqa: E501
        if include_optional :
            return InvalidStopRequest(
                error = '0'
            )
        else :
            return InvalidStopRequest(
    ...
    def testInvalidStopRequest(self):
        """Test InvalidStopRequest"""
